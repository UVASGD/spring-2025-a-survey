...
Shader "RED_SIM/Water/Surface Uber Caustics"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float DepthSmoothing679 = saturate( (0.0 + (( eyeDepth167 - ase_screenPos.w ) - 0.0) * (1.0 - 0.0) / (_DepthSmoothing - 0.0)) );
			...
			float3 temp_output_1_0_g83 = float3( 1,0,0 );
			...
			float3 temp_output_2_0_g83 = appendResult10_g80;
			float dotResult3_g83 = dot( temp_output_1_0_g83 , temp_output_2_0_g83 );
			float3 break19_g83 = cross( temp_output_1_0_g83 , temp_output_2_0_g83 );
			float4 appendResult23_g83 = (float4(break19_g83.x , break19_g83.y , break19_g83.z , ( dotResult3_g83 + 1.0 )));
			float4 normalizeResult24_g83 = normalize( appendResult23_g83 );
			float4 ifLocalVar25_g83 = 0;
			if( dotResult3_g83 <= 0.999999 )
				ifLocalVar25_g83 = normalizeResult24_g83;
			else
				ifLocalVar25_g83 = float4(0,0,0,1);
			float temp_output_4_0_g84 = ( UNITY_PI / 2.0 );
			float3 temp_output_8_0_g83 = cross( float3(1,0,0) , temp_output_1_0_g83 );
			float3 ifLocalVar10_g83 = 0;
			if( length( temp_output_8_0_g83 ) >= 1E-06 )
				ifLocalVar10_g83 = temp_output_8_0_g83;
			else
				ifLocalVar10_g83 = cross( float3(0,1,0) , temp_output_1_0_g83 );
			float3 normalizeResult13_g83 = normalize( ifLocalVar10_g83 );
			float3 break10_g84 = ( sin( temp_output_4_0_g84 ) * normalizeResult13_g83 );
			float4 appendResult8_g84 = (float4(break10_g84.x , break10_g84.y , break10_g84.z , cos( temp_output_4_0_g84 )));
			float4 ifLocalVar4_g83 = 0;
			if( dotResult3_g83 >= -0.999999 )
				ifLocalVar4_g83 = ifLocalVar25_g83;
			else
				ifLocalVar4_g83 = appendResult8_g84;
			...
			float4 temp_output_2_0_g97 = (( _MatchCausticsDirectionWithLightSource )?( ifLocalVar4_g85 ):( ifLocalVar4_g83 ));
			...
			o.Emission = lerpResult987.rgb;
			float lerpResult1024 = lerp( _Smoothness , _FoamSmoothness , FoamFinal1013);
			o.Smoothness = ( lerpResult1024 + ( _ZWrite * 0.0 ) );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17500
1927;31;1906;987;-3185.04;1019.237;1;True;False
...
Node;AmplifyShaderEditor.PowerNode;720;-2882.106,-1379.669;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;236;-2324.513,-792.6731;Inherit;False;1206.328;529.2575;Regular Depth For Smoothing;8;679;232;230;229;168;167;166;549;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.PowerNode;585;-1711.455,-1414.743;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;692;-1710.561,-1070.731;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;911;-450.64,1501.518;Inherit;False;Property;_CausticsDirection;Caustics Direction;40;0;Create;True;0;0;False;0;0,0,0;-9.7,34.54,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;909;52.37244,1509.11;Inherit;False;FromToRotation;-1;;83;ad10913350839ec49a3853aee4185e18;0;2;1;FLOAT3;1,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;294;707.1525,-3669.872;Float;False;Property;_EdgeMaskShiftpx;Edge Mask Shift (px);27;1;[IntRange];Create;True;0;0;False;0;2;2;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;910;288.3727,1560.11;Inherit;False;Property;_MatchCausticsDirectionWithLightSource;Match Caustics Direction With Light Source;41;0;Create;True;0;0;False;0;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;795;-591.4421,3220.355;Inherit;False;Property;_CausticsSpeed;Caustics Speed;33;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;828;22.15459,2355.936;Inherit;False;Property;_CausticsRefractionSize;Caustics Refraction Size;35;0;Create;True;0;0;False;0;1;0.155;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;810;88.64494,2724.891;Float;False;Property;_CausticsRefractionPower;Caustics Refraction Power;36;0;Create;True;0;0;False;0;0.5;0.045;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;813;530.8366,2657.888;Inherit;True;Property;_TextureSample1;Texture Sample 1;37;0;Create;True;0;0;False;0;-1;None;8d1c512a0b7c09542b55aa818b398907;True;0;True;bump;Auto;True;Instance;812;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;564;2382.861,-1864.291;Inherit;False;Property;_FixUnderwaterEdges;Fix Underwater Edges;28;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;1012;2381.97,1279.373;Inherit;False;2105.521;1021.313;Foam;26;971;963;965;995;998;999;1000;967;966;979;978;976;984;997;996;959;983;973;1010;1009;1011;972;992;962;964;977;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;762;152.4747,1984.864;Inherit;False;Property;_CausticsSize;Caustics Size;32;0;Create;True;0;0;False;0;20;40;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1009;2482.637,1821.998;Inherit;False;Property;_FoamMaskDistortionPower;Foam Mask Distortion Power;44;0;Create;True;0;0;False;0;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;983;2481.156,1728.705;Inherit;False;730;FovFactor;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;973;2736.32,1701.137;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;959;2431.97,1644.737;Inherit;False;982;NormalShiftSource;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;219;388.9003,-1031.88;Inherit;False;188;DepthMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenColorNode;223;392.7033,-1337.707;Float;False;Global;_GrabWater;GrabWater;-1;0;Create;True;0;0;False;0;Object;-1;True;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;779;-458.5025,3437.978;Inherit;False;Property;_CausticsDispersion;Caustics Dispersion;34;0;Create;True;0;0;False;0;0.25;0.204;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;962;2541.892,1906.945;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1010;2878.997,1698.712;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;971;3041.543,1721.727;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;933;532.8181,3643.417;Inherit;False;Property;_CausticsDarknessLimit;Caustics Darkness Limit;38;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;938;508.9136,3718.863;Inherit;False;Property;_CausticsBrightnessGradation;Caustics Brightness Gradation;39;0;Create;True;0;0;False;0;0;0.429;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenPosInputsNode;964;3035.747,1821.373;Float;False;1;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ScreenDepthNode;963;3188.289,1736.708;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1015;2377.248,293.2609;Inherit;False;2060.904;959.8669;Fog Visual;21;1013;1005;989;1008;1007;1004;994;1006;991;1003;993;1023;1002;1001;1022;1021;1020;1018;1019;1017;1016;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1016;2447.419,1116.812;Inherit;False;Property;_RotationAnimationSpeed;Rotation Animation Speed;53;0;Create;True;0;0;False;0;1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;965;3405.966,1740.05;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;972;2519.021,1516.641;Inherit;False;Property;_FoamDistortionPower;Foam Distortion Power;45;0;Create;True;0;0;False;0;1;0.414;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;996;3460.022,1371.638;Float;False;Property;_FoamSize2nd;Foam Size 2nd;50;0;Create;True;0;0;False;0;0.15;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;1017;2732.979,1124.208;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;977;3536.897,1737.294;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;966;3462.303,2066.709;Float;False;Property;_FoamMaskSize;Foam Mask Size;47;0;Create;True;0;0;False;0;0.05;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;545;1429.585,-261.9949;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;1018;2928.979,1168.208;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;997;3605.616,1504.615;Inherit;False;Property;_FoamGradation2nd;Foam Gradation 2nd;51;0;Create;True;0;0;False;0;15;15;0;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;934;1138.818,3568.417;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1020;2761.498,999.0099;Inherit;False;Property;_RoatationAnimationRadius;Roatation Animation Radius;52;0;Create;True;0;0;False;0;0.2;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;759;970.0731,3370.605;Inherit;False;Property;_CausticsPower;Caustics Power;30;0;Create;True;0;0;False;1;Header(Caustics);0;1.26;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;995;3693.26,1329.373;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.25;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1011;2877.844,1563.903;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CosOpNode;1019;2927.979,1079.208;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;979;3609.897,2185.686;Inherit;False;Property;_FoamGradation;Foam Gradation;48;0;Create;True;0;0;False;0;6;6;0;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1022;3076.979,1056.208;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;992;3032.199,1558.896;Inherit;False;FoamUVShift;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1021;3074.979,1145.208;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;998;3900.616,1358.615;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;967;3692.541,1972.444;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.25;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;978;3899.896,2001.686;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;1023;3216.979,1098.208;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;1002;3013.418,800.931;Inherit;False;992;FoamUVShift;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;999;4056.719,1357.774;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;1001;2972.115,657.9462;Inherit;False;0;1004;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;991;3189.408,362.34;Inherit;False;0;989;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;976;4056,2000.845;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;449;2216.8,-576.6442;Float;False;Property;_ColorClose;Color Close;5;0;Create;True;0;0;False;0;0,0.2196079,0.2627451,0;0,0.2627413,0.2623897,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;1003;3258.418,665.9309;Inherit;False;3;3;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;993;3211.978,502.4429;Inherit;False;992;FoamUVShift;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1000;4230.848,1354.803;Inherit;False;FoamMask2nd;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;543;2206.998,-745.2045;Float;False;Property;_ColorFar;Color Far;4;0;Create;True;0;0;False;0;0.1058824,0.5686275,0.7568628,0;0.1058787,0.5686274,0.7568628,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1004;3392.286,641.7489;Inherit;True;Property;_FoamTexture2nd;Foam Texture 2nd;49;0;Create;True;0;0;False;0;-1;None;50fdd0fbca63f0e49b8fc67f7b9ac764;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;1006;3466.311,841.4984;Inherit;False;1000;FoamMask2nd;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;984;4244.492,1989.735;Inherit;False;FoamMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;994;3456.978,367.4429;Inherit;False;3;3;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;662;2926.617,-412.1037;Inherit;False;527;DepthHeightMap;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1007;3761.311,719.4984;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1008;3787.747,565.5757;Inherit;False;984;FoamMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;989;3590.846,343.2609;Inherit;True;Property;_FoamTexture;Foam Texture;46;0;Create;True;0;0;False;0;-1;None;212f3bfdd0f3ab74c8346cc879f7deee;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;1005;4041.311,520.9984;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1013;4195.153,518.5592;Inherit;False;FoamFinal;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;985;3784.465,-629.7148;Inherit;False;Property;_FoamColor;Foam Color;42;0;Create;True;0;0;False;1;Header(Foam);0,0,0,0;1,1,1,0.41;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1029;3857.04,-236.9634;Inherit;False;Property;_ZWrite;ZWrite;29;1;[Toggle];Create;True;2;Option1;0;Option2;1;1;;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1025;2913.781,-235.7915;Float;False;Property;_FoamSmoothness;Foam Smoothness;43;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1024;4011.759,-368.3073;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleContrastOpNode;660;3833.862,-721.1379;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1031;4193.68,-363.8448;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;392;3838.892,-1018.543;Float;False;Property;_Tint;Tint;3;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;987;4152.792,-720.7637;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;369;3836.883,-830.7192;Inherit;False;315;NormalWater;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;4473.12,-833.364;Float;False;True;-1;7;ASEMaterialInspector;0;0;Standard;RED_SIM/Water/Surface Uber Caustics;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;True;True;False;Back;0;True;1029;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;-1;True;Opaque;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;False;0;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;31;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;2;987;0
WireConnection;0;4;1031;0
ASEEND*/
//CHKSM=FD012D1E433FA7730F2D3171703B1959D76A4B21