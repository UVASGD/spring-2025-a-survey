...
namespace iffnsStuff.iffnsVRCStuff.InteractiveControllers
{
    public class RotationGrabController : UdonSharpBehaviour
    {
        ...
        */
        ...
        [SerializeField] [UdonSynced] float SyncValue = 0f;
        ...
        void Update()
        {
            ...
            if (pickupIsHeld && Networking.IsOwner(gameObject))
            {
                ...
                SyncValue = GetOutputValueFromAngle(angleDeg: currentAngleDeg);
            ...
            {
                transform.localRotation = Quaternion.Euler(Vector3.forward * GetAngleDegFromOutputValue(SyncValue));
            }
